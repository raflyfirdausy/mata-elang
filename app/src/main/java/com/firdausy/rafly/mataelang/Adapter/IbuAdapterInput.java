...
public class IbuAdapterInput extends BaseAdapter {
    private Activity activity;
    private List<IbuModel> data;
    private List<IbuModel> dataSementara;

    public IbuAdapterInput(Activity activity, List<IbuModel> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ibuHolder.tv_emailIbu.setText(data.get(position).getNomerHp());
