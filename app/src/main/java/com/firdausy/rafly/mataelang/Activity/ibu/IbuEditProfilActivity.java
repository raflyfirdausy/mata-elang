...
public class IbuEditProfilActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    private Context context = IbuEditProfilActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ibu_edit_profil);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        tabFragmentAdapter.addFragment(new EditDataDiriFragment(), getString(R.string.data_diri));
